...
class MoveObstacleEnv(PybulletEnv):
    """
    ...
    def reset(self):
        ...
        self.create_table()
        # create basket
        # self.create_basket(x = 0.7, y = 0, w = 0.5, l = 0.2)

        # create boxes
        self.create_box(name="red_box", color=RED, x=0.4, y=0, z=0.11)
        self.create_box(name="blue_box", color=BLUE, x=0.4, y=0, z=0.25)
        self.create_box(name="green_box", color=GREEN, x=0.4, y=0, z=0.36)
        self.simulate()
